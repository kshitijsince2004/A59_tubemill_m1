...
export default function ArcWeldPanel({
  runId,
  coils,
  disabled,
}: {
  ...
  const mut = useMutation({
    mutationFn: (body: Record<string, unknown>) => tubemillApi.addArcWeld(runId, body),
    onSuccess: () => {
  ...
  return (
    <section className="panel">
      ...
      >
        <select name="coilInputId" required disabled={disabled} className="z-input">
